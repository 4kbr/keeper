...
const AddItem = () => {
    ...
    const savedItem = async (e)=>{
        e.preventDefault();
        await axios.post(uri+"/tables/add",{
            nik:nik,
            nama:nama,
            foto:foto,
        });
      ...
      <Container>
          <TableForm color="lightgray">
            <TableRows name="nik">
                ...
                <InputContainer>
                <InputItem placeholder='Masukkan NIK' value={nik} onChange={(e)=>setNik(e.target.value)}/>
                </InputContainer>
            ...
            <TableRows name="nama" >
                ...
                <InputContainer>
                <InputItem placeholder='Masukkan NAMA' value={nama} onChange={(e)=>setNama(e.target.value)}/>
                </InputContainer>
            ...
            <TableRows name="add">
                <Button color="#00b400" onClick={savedItem}><Add/></Button>
